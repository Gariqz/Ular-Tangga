# Ular-Tangga
Ladder Snake Game based on C++ with CMake and SFML
# How to run it?
You can run the app by following these steps:
1. Make sure you installed CMake already! 
2. Don't change anything in CMakeLists.txt (unless you know what you're doing!) 
3. Personally, i don't install SFML myself, i fetch it from their docs. So if you would like to do it so, leave it be
4. Make sure you have CMake Tools Extension installed on your Visual Studio Code
5. Configure it by pressing (Ctrl+Shift+P) then choose your own compiler
6. Wait for the installation finish
7. Once it finish, you can write down ```cmake --build .\build\``` in your terminal
8. Then run it by using ```.\build\bin\SnakeBoardGame.exe```
9. Enjoy Playing!
##
